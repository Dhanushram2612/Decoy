"""
PhishGuard AI — Multi-layer Phishing Detection Suite
URL (XGBoost + Char-Transformer + Domain-Trust Allowlist) + Email (BERT) + Groq LLM explanation
"""
...
# ----------------------------------------------------------------------------
# STYLING — dark, gradient, glassy cards
# ----------------------------------------------------------------------------
st.markdown("""
<style>
...
# ----------------------------------------------------------------------------
# CONFIG — model files pulled from Hugging Face Hub at startup
# (avoids storing large binaries in the GitHub repo / hitting LFS bandwidth caps)
# ----------------------------------------------------------------------------
@st.cache_resource
